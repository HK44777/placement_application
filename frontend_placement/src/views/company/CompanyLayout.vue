<template>
  <div class="bg-light min-vh-100">
      ...
      <div class="container">
        ...
        <div class="dropdown">
          <button class="btn btn-dark dropdown-toggle" data-bs-toggle="dropdown">
            {{ user ? user.company_name : 'My Account' }}
          </button>
          <ul class="dropdown-menu dropdown-menu-end">
            <li>
              <router-link class="dropdown-item" to="/company/profile">View Profile</router-link>
            </li>
            <li>
              <router-link class="dropdown-item" to="/company/dashboard">Dashboard Home</router-link>
            </li>
            <li>
    ...
    <!-- Render the current company page -->
